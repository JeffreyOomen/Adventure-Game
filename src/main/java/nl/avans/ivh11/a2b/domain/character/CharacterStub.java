...
@Setter
@NoArgsConstructor
public abstract class CharacterStub implements Opponent {
    @Id
     ...
     * @param stats
     */
    public CharacterStub(String name, Stats stats) {
        this.name = name;
        this.stats = stats;
...
//    }
    ...
    public void mountEquipment2(UsableType usableType, Equipment equipment) {
        // Make sure only one weapon can be equipped
